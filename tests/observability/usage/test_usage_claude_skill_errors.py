...
class ClaudeSkillErrorTest(unittest.TestCase):
    """``_skills.parse_claude_skills`` over synthetic ``stream-json`` runs.
    ...
    def test_available_empty_without_init_skills(self) -> None:
        ...
        for frame in (
            ...
            with self.subTest(frame=frame):
                skills = _skills.parse_claude_skills(_jsonl.jsonl(frame))
    ...
    def test_empty_stdout(self) -> None:
        self.assertEqual(_skills.parse_claude_skills(""), _skills.SkillTriggers())
