...
"""Dashboard throughput and chart-height tests."""
...
def _load_chart_dependencies():
    ...
    return charts, read_module


try:
    dashboard_charts, _analytics_read = _load_chart_dependencies()
...
class ChartHeightsTest(unittest.TestCase):
    ...
    the panel's content shape (hero / horizontal bars / throughput
    strip); the visual-review task #341 follow-up pinned these
    heights as the single biggest "now it looks designed" lever
    after the segmented control.
    """
