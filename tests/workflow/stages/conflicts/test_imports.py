...
_FLAT_MODULES = (
    "orchestrator.stages._conflicts_export_manifest",
    "orchestrator.stages._conflicts_exports",
...
def _stage_targets() -> list:
    ...
    return [
        ...
        if "conflicts" in target.module_name
    ]
...
class CleanProcessImportTest(unittest.TestCase):
    ...
    / dirty-tree parks, and the body-edit disposition from, all of which reach
    the workflow facade, whose hooks resolve back into this package. A
...
class OwnerImportSiteTest(unittest.TestCase):
    ...
    def test_no_flat_module_exists(self) -> None:
        ...
        # round counters, the divergence lease, and the park reasons live issues
...
class DispatchTargetTest(unittest.TestCase):
    ...
    def test_label_resolves_to_the_handler_owner(self) -> None:
        ...
        self.assertEqual(
            _dispatch._STAGE_HANDLER_TARGETS["resolving_conflict"],
