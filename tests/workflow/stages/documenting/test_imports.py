...
_FLAT_MODULES = (
    "orchestrator.stages._documenting_export_manifest",
    "orchestrator.stages._documenting_exports",
...
def _stage_targets() -> list:
    ...
    return [
        ...
        if "documenting" in target.module_name
    ]
...
class CleanProcessImportTest(unittest.TestCase):
    ...
    owners, which reach the workflow facade, whose hooks resolve back into this
...
class OwnerImportSiteTest(unittest.TestCase):
    ...
    def test_no_flat_module_exists(self) -> None:
        ...
        # awaiting-human flag, the last-action comment id, and the park reasons
...
class DispatchTargetTest(unittest.TestCase):
    ...
    def test_label_resolves_to_the_handler_owner(self) -> None:
        ...
        self.assertEqual(
            _dispatch._STAGE_HANDLER_TARGETS["documenting"],
