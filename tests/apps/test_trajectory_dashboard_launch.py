...
class ScriptPathLaunchTest(unittest.TestCase):
    ...
    def _launched(
        ...
        with _launch_sandbox(_is_launch_world):
            ...
            # The composition the entry function defers is what the shim is
            # for, so resolving it is what says the repo root landed -- and,
            # with a decoy parent on the path, that the real package answered.
