...
is at, whether this clone's own object store has a given commit at all, and
whether the base the remote named already contains a given tip. What the
answers are spent on is ``eligibility``'s subject; what they ARE is this
module's.
