...
an interrupted one got with the exemption it was carrying: the tick that makes
the rewrite and the tick that comes back to it are decided on the same
evidence, so it belongs to neither of them. ``refresh``
