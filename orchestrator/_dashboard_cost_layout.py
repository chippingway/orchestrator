...
The cost surface that names this module reaches those rather than a copy, so
the three families it publishes cannot be framed one way here and another under
the owner.
"""
