...
objects. The usage, cost, and throughput leaves that name this module reach
those rather than a copy, so a panel's empty state, its bar labels, and its
height cannot be answered one way here and another under the owner.
"""
