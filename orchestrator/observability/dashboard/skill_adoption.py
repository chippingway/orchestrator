...
tracking nobody turned on. A window that produced cells always renders the
table, however quiet they are, since an offered-but-never-loaded skill is the
finding rather than a row to drop.
