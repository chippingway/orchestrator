...
# pair, the activity grid beneath them, the recent-run listing, the hero usage
# card and the totals behind its stack, or any of the seven page-state
# shapes -- would move that object off the owner that defines it.
