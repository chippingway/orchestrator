...
"""Historical surface for the read-only question session, run, and outcome helpers.

The owners live in :mod:`orchestrator.workflow.stages.question`; every name here
resolves to the owner's own object rather than a rebuilt one, so a caller
