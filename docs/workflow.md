...
once its callers name the owner — `validating`, `in_review`, and `question` have none left. The dispatcher and the
same-tick pickup start name the owner directly. The per-stage
