...
orchestrator/
  ...
  git/                  local git: execution, locks, and authenticated
                        ...
                        inventory of the checkouts and branches it leaves and
                        the classification that says which of them a finished
                        issue may have reclaimed, the per-tick base sync,
